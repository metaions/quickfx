...
// var CountryPicker
// try{
//      CountryPicker = require("react-native-country-codes-picker/components/CountryPicker")
// }
// catch(e)
// {
//     console.log("error countrypicker "+e)
// }
...
const SignUpScreen = ({ navigation }) => {
    ...
    React.useEffect(() => {
        // navigation.navigate("SignUpDetail",{uid:"TOP",pw:"123456",txnpw:"123456"})
        return;
                        ...
                        fetch(url)//+'&mno='+ Mob
                            ...
                            .then(signupData => {
                                ...
                                if (signupData.success === 'true') {
                                    ...
                                    navigation.navigate("SignUpDetail", { uid: signupData.uname, pw: data.password, txnpw: data.txnPassword,token:signupData.token,apptype:signupData.isbotz,txn:signupData.txn })
        ...
        <ImageBackground source={global.bgimg} resizeMode="stretch"
            ...
            <View style={[styles.container]}>
                <ScrollView style={{ zIndex: 9999, paddingBottom: 0 }}
                    ...
                    <TouchableOpacity
                        ...
                        <Text style={{ color:colors.selected, fontSize: 18,fontFamily:global.appFontM, padding: 5 }}>LOGIN</Text>
                    </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.action}>
                            ...
                            <TouchableOpacity onPress={Count ? null :
                                ...
                                <View style={[{
                                    ...
                                    {Count ? null : <Text style={[styles.text, { color: '#000', fontSize: 12, }]}>SEND OTP</Text>}
                                    {Count ? <Text style={[styles.text, { color: '#000', fontSize: 12, }]}>RESEND OTP IN: <Text style={{ fontSize: 10 }}> {seconds}</Text>  </Text> : null}
            ...
            />
                        ...
                        <View style={styles.action}>
                            ...
                            <TouchableOpacity onPress={updateSecureTextEntry}>
                                {data.secureTextEntry ?
                                    ...
                                    style={{width:20,height:15,tintColor:colors.profitcolor2}} />
                            ...
                            <TouchableOpacity onPress={updateSecureTextEntryTxn}>
                                {data.secureTextEntryTxn ?
                                    ...
                                    <Image source={require('../../assets/botz/not-view.png')}
                                     resizeMode="contain" style={{width:20,height:15,tintColor:colors.profitcolor2}} />
                                    :
                            ...
                            <View style={styles.action}>
                                ...
                                {data.refer !== '' ? <TouchableOpacity onPress={() => { setLoadingRef(true), getEmailApi() }} style={{}} >
                                    <View style={[{
                                        alignItems: 'center', flexDirection: 'row', justifyContent: 'center',
                                        paddingHorizontal: 5,
                                        borderRadius: 40, paddingVertical: 5, backgroundColor: '#bababa',
                                    }]}>
                                        <Text style={{ color: '#fff', fontSize: 12 }}>Validate ID</Text>
                        ...
                        {emailRef !== '' ? <View style={[{
                            ...
                            <Text style={[styles.text, { color: 'gray', fontSize: 13 }]}>Email ID : <Text style={[styles.text, { color: colors.binanceylw2, fontSize: 15 }]}>{emailRef}</Text></Text>

                        </View> : null}                        
                         

                        
                         <TouchableOpacity disabled={(data.email!='' && data.password!='' && !Loading)?false:true} onPress={()=>{setLoading(true),signupHandle()}} 

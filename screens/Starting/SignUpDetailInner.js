...
const SignUpDetailInner = ({ navigation, route }) => {
    ...
    return (
        <ImageBackground
            ...
            <Image source={require('../../assets/Aeon/sidebar/onenes_logo.png')} resizeMode={'stretch'}
                style={{ marginTop: 40, width: 170, height: 150,marginBottom:20 }} />
            <ImageBackground source={require('../../assets/Aeon/registration_bg.png')}
                ...
                <View style={{ margin: 20,  marginTop: 20 }}>
                    ...
                    >
                        ...
                        <Text style={{ color: colors.profitcolor2,fontFamily:global.appFontM
                        ...
                        marginTop: 15, }}>Your account is registered successfully.</Text>
                         <View style={{ width: '80%', alignItems: 'center', justifyContent: 'center', alignSelf: 'center', marginTop: 30 }}>
                             <Text style={[styles.textLeft, { color: colors.selected }]}>Username</Text>
                            <View style={{
                                width: '100%', flexDirection: 'row', alignItems: 'center', 
                                padding: 10, paddingVertical: 5,
                                borderRadius: 5,
                                borderColor: 'rgba(255, 255, 255, 0.2)',
                                borderBottomWidth: 1.5, borderColor:colors.selected,marginBottom:10,
                            }}>
                                <Image source={require('../../assets/signup/ico1.png')} style={{ width: 20, height: 20, marginRight: 10, tintColor:colors.profitcolor2 }} />
                            ...
                            <Text style={[styles.textLeft, { color: colors.selected }]}>Password</Text>
                            <View style={{
                                width: '100%', flexDirection: 'row', alignItems: 'center', padding: 10, paddingVertical: 5,
                                borderRadius: 5,
                                borderColor: 'rgba(255, 255, 255, 0.2)',
                                borderBottomWidth: 1.5, borderColor:colors.selected,marginBottom:10, marginTop: 10
                            }}>
                                <Image source={require('../../assets/signup/ico2.png')} style={{ width: 20, height: 20, marginRight: 10, tintColor:colors.profitcolor2 }} />
                                <View style={{ flexDirection: 'column', marginLeft: 5 }}>
                            ...
                            <Text style={[styles.textLeft, { color: colors.selected }]}>TXN Password</Text>
                            <View style={{
                                width: '100%', flexDirection: 'row', alignItems: 'center', padding: 10, paddingVertical: 5,
                                borderRadius: 5,
                                borderColor: 'rgba(255, 255, 255, 0.2)',
                                ...
                                <Image source={require('../../assets/signup/ico3.png')}
                                    style={{ width: 20, height: 25, marginRight: 10, tintColor:colors.profitcolor2 }} />
                                <View style={{ flexDirection: 'column', marginLeft: 5 }}>
                        ...
                        <TouchableOpacity
                            style={{
                                ...
                                shadowColor: colors.appBlue,
                                 shadowOpacity: 0.2,backgroundColor:colors.profitcolor2,
...
export default SignUpDetailInner;

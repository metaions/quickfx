...
const callBackFn = (item) => {
  ...
  navigation.navigate('copytradingsecond',{item})
  // setSelectedIndex(a)
  // setInsPrice(price)
  // setInsurance(insIndex)
}
              ...
              resizeMode='stretch'
                ...
                >                                       
                   <View style={{marginLeft:0,marginRight:-20,alignItems:'center',justifyContent:'center'}}>
                      ...
                      <Text style={{color:colors.binanceylw3,fontSize:17,textAlign:'left',lineHeight:30}}>Sign Up, start copying any Master Trader!</Text>
                ...
                {/* {
                    global.CopyId?(
                      <View style={{padding:10,borderColor:colors.selected,borderWidth:1,borderRadius:50,marginTop:-50,width:'60%'
                      ,alignSelf:'center',backgroundColor:'#181c25'
                      }}>
                      <Text style={{color:'aqua',fontSize:18}}><Text style={{color:'#fff'}}>Currently Copying </Text>:  {global.CopyId}</Text>
                      </View>
                      )
                      :null
                  } */}
    ...
    ,padding:10,margin:5,borderRadius:5}}>
      <Text style={{color:'#fff',fontWeight:'bold',fontSize:16}}>Sort by : Copiers</Text>
      <View 
    ...
    {!Loading && data!=null?     
        ...
        //  uid={item.uid}
         <CopyBox name={item.pname}  rank={item.rank} 

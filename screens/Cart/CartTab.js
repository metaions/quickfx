...
function Img_check (uid){    
    ...
    if(rnd==1){
        ...
        return require('../../assets/wall6.png')
    }
  ...
  return (    
     ...
     <View style={{flexDirection:'column',justifyContent: 'center',height:700,backgroundColor:colors.background}} >
      ...
      <View style={[styles.container,{paddingTop:30}]}>                      
                <Image source={require('../../assets/logo.png')} style={{width:240,height:80,alignSelf:'center',}} resizeMode={'contain'} />
                <TouchableOpacity onPress={()=>{takeScreenShot()}} style={{position:'absolute',top:60,right:30}}>
               ...
               <FlatList
                    ...
                    renderItem={({ item, index }) => {                                                    
                        return (
                        <ImageBackground source={Img_check()} resizeMode={'stretch'} style={{width:'100%',height:200,alignSelf:'center',justifyContent:'center',marginVertical:15}}>        

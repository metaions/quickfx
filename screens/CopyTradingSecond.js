...
import { View, Text, Button, Dimensions, TouchableOpacity, ToastAndroid, StyleSheet, RefreshControl, 
  Image, StatusBar, FlatListProps, ListRenderItemInfo, FlatList, ScrollView, TextInputComponent, 
...
// import CopyBoxSecond from '../component/CopyBoxSecond';
...
const CopyTradingSecond = ({route, navigation }) => {
  ...
  const callApi = () => {    
    let url = global.BASE_URL + "css_mob/copy_traders.aspx?uid=" + global.uid
    console.log(url)
    fetch(url)
      .then(item => item.json())
      .then(CData => {
  ...
  return (
    ...
    style={{ flex: 1,  width: '100%',
      ...
      style={{  marginTop: 40,height: 150  }}>
        ...
        marginTop:10 }}>MASTER RATING</Text>
      </ImageBackground>
        ...
        style={{
          ...
          alignItems: 'flex-start',borderRadius:5,
           ...
           {(item!=null && item!='' && item!=undefined)?<ImageBackground 
                    resizeMode={'stretch'}
                    source={require('../assets/Fxbot/copy/boxBg.png')} 
                 ...
                 marginBottom:10,marginLeft:'1%'}} >
                  ...
                  <View style={{ flexDirection: 'row',marginHorizontal:8,marginTop:10,
                   height:62 ,justifyContent:'space-between',}}>
                        ...
                        {/* <Image source={item.rankimg==''?require('../assets/botz/master/star.png'):{uri:item.rankimg}}
                        ...
                        width:'40%' ,}}>
                            ...
                            style={{backgroundColor:parseInt(item.st)==0?colors.green1:'#ff0000',padding:5,paddingHorizontal:8,borderRadius:3,display: parseInt(item.st)==2?'none':'flex' }}>
                              <Text style={{color:colors.selected}}>  {parseInt(item.st)==0?'Start Copying':'Stop Copying'} </Text>
                    ...
                    <View style={{justifyContent: 'space-between',flexDirection:'row',alignItems:'center',
                        ...
                        <View style={{flexDirection:'column',justifyContent: 'center',alignItems: 'center',width:'26%'}}>
                         <Text style={{fontSize:10,color:colors.selected}}  allowFontScaling={false}>COPIERS</Text>
                            <Text style={{color:colors.selected,fontSize:17,textAlign: 'center',fontFamily:global.bold}}  allowFontScaling={false}>{item.copiers}</Text>
                        ...
                        width:'100%',alignSelf: 'center',marginTop:5,height:20}}>
                            ...
                            {/* <Text style={{fontSize:13,color:'white'}}  allowFontScaling={false}>Loss</Text>        */}
                        ...
                        width:'100%',alignSelf: 'flex-start',height:22,}}>
                           ...
                           {/* <ProgressBar progress={parseFloat(item.profit)/(parseFloat(item.profit)+parseFloat(item.loss)*100)} 
                           color={colors.green1} 
                           style={{backgroundColor:colors.red1,height:5,width:330,borderRadius:10}}/> */}
                            </View>
                            </View>
...
<Text style={{color:'white'}}>DISCLAIMER : </Text>
<Text style={{color:'white'}} numberOfLines={6}>
All Copy Traders And Autobot Trade On basis Of Signals, News Or Chart Readings .{'\n'}So There Is No Gurantee of 100% Profit. 
...
export default CopyTradingSecond;

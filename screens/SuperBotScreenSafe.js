...
const SuperBotScreenSafe = ({navigation, route}) => {
  ...
  const [Btype, setBtype] = React.useState('high');
...
// console.log('in super bot----------------------------'+hedge)
  ...
  const EditInvest = async () => {
    ...
    //     console.log('trade cap check2 ',tradeCap ,1.2 * parseFloat(global.balance));
  ...
  const Invest = async () => {
    ...
    let url =
      ...
      '&risk='+selectedRisk+
      '&capital='+tradeCap+
      '&type=' +'safe' +'&account_mode='+globalAcc+
      '&token=' +
      token +
      '&device=' +
      DeviceInfo.getUniqueId() +
  ...
  return Loading ? (
    <ImageBackground
    source={require('../assets/Aeon/bgsafe.png')}
      style={{
...
<ImageBackground
    source={require('../assets/Aeon/safebotbg.png')}
     style={{flex: 1, width: '100%', height: '100%',}}>
      <View style={[styles1.container,{height: '100%', }]}>
          ...
          <Modal
            ...
            <View
              ...
              <Text
                ...
                Are you sure,you want to Stop the {Btype=='low'?'SUPER BOT V2':Btype=='high'?'SUPER BOT V3':Btype=='gold'?'GOLD BOT':'SUPER BOT'}?
              </Text>
              <View
                style={{
                  flexDirection: 'row',
       ...
       <Image
        source={require('../assets/Aeon/safebots.png')}
      ...
      <ImageBackground
       source={require('../assets/Aeon/superbot/box_two.png')}
       style={{width: '94%', height: 90,alignItems:'center',justifyContent: 'center',marginTop:20}}
       resizeMode='stretch'
       > 
      ...
      <Text
          ...
          :
           <View
              ...
              {/* <Text
                ...
                V3</Text> */}
                <Image source={require('../assets/Aeon/safebot.png')}
                style={{position: 'relative', top: 0,width:220,height:100}} resizeMode="contain"/>

              <View 
                style={{top: 10, paddingHorizontal: 10,width:'96%',alignItems:'center',justifyContent: 'center'
                }} >
                { Started!=='True'? <ImageBackground
              animation={'slideInUp'}
              duration={1500}
              useNativeDriver={true}
              source={require('../assets/Aeon/safebot_bg.png')}
              resizeMode={'stretch'}
              style={{width: 200, height: 350,marginTop:0,position:'relative'}}
            >
                  <View 
                style={{
                  marginTop:180,
                  ...
                  <Text
                    style={{
                      color: '#eea414',
                      fontSize:30, //global.balance.length>3?40:54,
                      fontFamily:fontBold,
          ...
          <View style={{zIndex: 999, width:'100%', alignSelf:'center',marginTop:50
              }}>
            {Started == 'True' ? (
              <View
                style={{
                  ...
                  >
                    <Text
                      style={{
                        color: colors.selected,
                        fontSize: 20,
                        fontFamily: global.bold, marginLeft:0
                      }}>
                      EDIT
                    </Text>
                  </ImageBackground>
              ...
              <>
                ...
                disabled={!BTN}
                  ...
                  activeOpacity={0.9}
                  style={{alignSelf:'center',alignItems: 'center',width:'65%',position:'absolute',
                  top:0,zIndex:9999,}}>
                  <View
                    // source={require('../assets/Aeon/hedgebotFX/start_btn.png')}
                    // resizeMode={'stretch'}
                    style={{
                      alignItems: 'center',
                      justifyContent: 'center',
          ...
          {/* <View style={{ alignSelf: 'center', alignItems: 'flex-start', justifyContent: 'center',
           marginTop: Started=='True'?10:20}}>
...
export default SuperBotScreenSafe;

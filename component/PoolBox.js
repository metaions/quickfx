...
function CopyBox({ name, dt, description, profit, min, max, uid, copyid, rank, rankimg, loss, copiers, comm, img
    ...
    return (
        ...
        <ImageBackground
            ...
            source={require('../assets/Fxbot/copy/listBoxWithLinesPool.png')}
            style={{
            ...
            >
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '48%' }}>
                        <Text style={{ fontSize: 12, color: colors.selected }} allowFontScaling={false}>PARTICIPANTS</Text>
                        <Text style={{ color: colors.selected, fontSize: 20, textAlign: 'center', fontFamily: global.bold }} allowFontScaling={false}>{copiers}</Text>

                    </View>
                    <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '48%' }}>
                        <Text style={{ fontSize: 12, color: colors.selected }} allowFontScaling={false}>GAIN</Text>
